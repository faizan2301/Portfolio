...
import { MOBILE_TOOLS } from "@/lib/tools/mobile/catalog";

export const metadata: Metadata = {
  title: "Mobile Development Tools | Dev Tools",
  description:
    "APK signatures, deep links, Intent URIs, Universal Links, FCM payloads, QR codes, ADB commands, permissions, and versioning utilities.",
};

export default function MobileToolsHubPage() {
  return (
    <section className="py-10 sm:py-14 md:py-16 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <SectionHeading
          ...
          title={
            <>
              Mobile <span className="neon-text">Toolkit</span>
            </>
          }
          subtitle="Android & iOS utilities for signing, deep linking, messaging, ADB, and versioning."
        />

        <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
          {MOBILE_TOOLS.map((tool) => (
            <Link key={tool.slug} href={`/tools/mobile/${tool.slug}`} className="group block">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-heading text-sm font-bold tracking-wider uppercase group-hover:neon-text transition-all">
                        {tool.name}
                      </h3>
                    </div>
