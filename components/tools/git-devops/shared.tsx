...
export function GitDevopsToolShell({
  title,
  subtitle,
  children,
}: {
  ...
  return (
    <section className="py-10 sm:py-14 md:py-16 relative overflow-hidden">
      <div
        className="absolute top-0 right-1/3 w-96 h-96 opacity-10 blur-3xl pointer-events-none"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <RevealGroup stagger={70}>
          <RevealItem>
            <SectionHeading badge="// Git & DevOps" title={title} subtitle={subtitle} />
          </RevealItem>
          {children}
        </RevealGroup>
      </div>
