...
export function DateTimeToolShell({
  title,
  subtitle,
  children,
}: {
    ...
    <section className="py-10 sm:py-14 md:py-16 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <RevealGroup stagger={70}>
          <RevealItem>
            <SectionHeading badge="// Date & Time" title={title} subtitle={subtitle} />
          </RevealItem>
          {children}
        </RevealGroup>
      </div>
...
export function StatCard({
  ...
  return (
    <div className="border border-border/60 bg-background/40 p-4 cyber-chamfer-sm">
      ...
      <p className="font-heading text-xl sm:text-2xl font-black tracking-wider neon-text">
        {value}
      </p>
    </div>
  );
